...
class LML extends MY_Controller
{
    ...
    public function data_detail()
    {
        ...
        $this->dbProd23->select("a.MR_No,a.Reg_No,a.Position_Status,
        b.Patient_Name,
        b.Date Date_Registration, b.payer, c.Company_Name, d.Doctor_Name
        ");
        $this->dbProd23->from("dbo.Header_Doc_LML a");
        $this->dbProd23->join("dbo.RI_Tran_Registrasi b", "b.Branch = a.Branch AND b.MR_No = a.MR_No AND b.IP_Registration_No = a.Reg_No" , "LEFT");
        $this->dbProd23->join("DB_Master_Fix.dbo.Perusahaan c", "c.Company_Code = b.Payer", "LEFT");
        $this->dbProd23->join("DB_Master_Fix.dbo.Dokter d", "d.Doctor_Code = b.Doctor_In_Charge", "LEFT");
        ...
        $this->dbProd23->select("a.MR_No,a.Reg_No,a.File_No,a.Position_Status,
        b.Patient_Name,
        b.Date Date_Registration, b.payer, c.Company_Name, d.Doctor_Name
        ");
        $this->dbProd23->from("dbo.Header_Doc_LML a");
        ...
        if ($dataSort == NULL OR "") {
            $this->dbProd23->order_by("A.Reg_No", "DESC");
