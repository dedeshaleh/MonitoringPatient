  ...
  <!-- <label for=""><?=$keyPasien?></label> -->
        ...
        <div class="row">
          ...
          <center>
            ...
            <div class="card" style="background-color: #f5f5f5; max-width: 700px;">
              <div class="card-body">
              ...
              if (data.DataDetail[i].Value == '' || data.DataDetail[i].Value == null) {
                ...
                <!-- timeline time label -->
                  ...
                  <div>
                    ...
                    html+=`
                    ;"></i>
                    <div class="timeline-item" style='transparent; padding-top:10px;'>
                      <div class="row">
                        <div class="col-sm-5 col-md-5" style='max-width: 200px; padding-left:20px; margin-left: 0px;'>
                          <div class='card card-primary' style='margin-bottom: 0px;'><div class='card-header'>`+data.DataDetail[i].Value+`</div></div>
                        </div>
                        <div class="col-sm-7 col-md-7">
                        <div class="timeline-item">
                      <!-- <span class="time"><i class="fas fa-clock"></i> 12:05</span> -->
                      <div class="card"> <div class='card-header' style="text-align: left !important;">`;
                      if (data.DataDetail[i].NamaKolom == 'Date_Leave_Room') {
