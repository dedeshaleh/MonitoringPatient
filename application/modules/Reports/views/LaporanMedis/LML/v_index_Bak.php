...
<script>
                      ...
                      var TblPatientData = new Tabulator("#TblPatient", {
												ajaxURL:"<?=base_url()?>Laporan/MedisLanjutan/data_detail/", //ajax URL
                        ...
                        maxHeight:"100%",
												...
												columns:[
													...
													{title:"Pasien", field:"Patient_Name", headerFilter:"input", cssClass: "custom-padding" },
													{title:"Asuransi", field:"Company_Name", headerFilter:"input", cssClass: "custom-padding" },
													{title:"Nomor Registrasi", field:"Reg_No", headerFilter:"input", cssClass: "custom-padding" },
													{title:"Tanggal Regis", field:"Date", headerFilter:"input", cssClass: "custom-padding",
                            formatter:function(cell, formatterParams, onRendered){
                              ...
                              return value.Date + ' - ' + value.Registration_Time;
														}, 
                          },
                          {title:"Tanggal PDS Kirim", field:"Date", headerFilter:"input", cssClass: "custom-padding",
                            formatter:function(cell, formatterParams, onRendered){
															var value = cell.getRow().getData();
                              // var btn = `<button type="button" class="btn btn-xs btn-success" onclick=GetUpload('`+value.IP_Registration_No+`')><i class="fa fa-upload"></i></button>`
                              return value.DateUploadPDS + ' - ' + value.TimeUploadPDS;
														}, 
                          },
                          {title:"Tanggal Dokumen Terima", field:"Date", headerFilter:"input", cssClass: "custom-padding",
                            formatter:function(cell, formatterParams, onRendered){
															var value = cell.getRow().getData();
                              // var btn = `<button type="button" class="btn btn-xs btn-success" onclick=GetUpload('`+value.IP_Registration_No+`')><i class="fa fa-upload"></i></button>`
                              return value.DateDocReceivePDS + ' - ' + value.TimeDocReceivePDS;
														}, 
                          },
                          {title:"Tanggal CASEMIX Approve", field:"Date", headerFilter:"input", cssClass: "custom-padding",
                            formatter:function(cell, formatterParams, onRendered){
															var value = cell.getRow().getData();
                              // var btn = `<button type="button" class="btn btn-xs btn-success" onclick=GetUpload('`+value.IP_Registration_No+`')><i class="fa fa-upload"></i></button>`
                              return value.DateCA_ApprovePDS + ' - ' + value.TimeCA_ApprovePDS;
														}, 
                          },
                          {title:"Tanggal PDS Terima", field:"Date", headerFilter:"input", cssClass: "custom-padding",
                            formatter:function(cell, formatterParams, onRendered){
															var value = cell.getRow().getData();
                              // var btn = `<button type="button" class="btn btn-xs btn-success" onclick=GetUpload('`+value.IP_Registration_No+`')><i class="fa fa-upload"></i></button>`
                              return value.DateReceivePDS + ' - ' + value.TimeReceivePDS;
														}, 
                          },
                          {title:"Tanggal Upload Kasir", field:"Date", headerFilter:"input", cssClass: "custom-padding",
                            formatter:function(cell, formatterParams, onRendered){
															var value = cell.getRow().getData();
                              // var btn = `<button type="button" class="btn btn-xs btn-success" onclick=GetUpload('`+value.IP_Registration_No+`')><i class="fa fa-upload"></i></button>`
                              return value.DateUploadKasir + ' - ' + value.TimeUploadKasir;
														}, 
                          },
                          {title:"Tanggal Dokumen Terima", field:"Date", headerFilter:"input", cssClass: "custom-padding",
                            formatter:function(cell, formatterParams, onRendered){
															var value = cell.getRow().getData();
                              // var btn = `<button type="button" class="btn btn-xs btn-success" onclick=GetUpload('`+value.IP_Registration_No+`')><i class="fa fa-upload"></i></button>`
                              return value.DateDocReceiveKasir + ' - ' + value.TimeDocReceiveKasir;
														}, 
                          },
                          {title:"Tanggal Casemix Approve", field:"Date", headerFilter:"input", cssClass: "custom-padding",
                            formatter:function(cell, formatterParams, onRendered){
															var value = cell.getRow().getData();
                              // var btn = `<button type="button" class="btn btn-xs btn-success" onclick=GetUpload('`+value.IP_Registration_No+`')><i class="fa fa-upload"></i></button>`
                              return value.DateCA_ApproveKasir + ' - ' + value.TimeCA_ApproveKasir;
														}, 
                          },
                          {title:"Tanggal Kasir Terima", field:"Date", headerFilter:"input", cssClass: "custom-padding",
                            formatter:function(cell, formatterParams, onRendered){
															var value = cell.getRow().getData();
                              // var btn = `<button type="button" class="btn btn-xs btn-success" onclick=GetUpload('`+value.IP_Registration_No+`')><i class="fa fa-upload"></i></button>`
                              return value.DateReceiveKasir + ' - ' + value.TimeReceiveKasir;
														}, 
                          },
