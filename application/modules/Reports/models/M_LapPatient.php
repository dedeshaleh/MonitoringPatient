...
class M_LapPatient extends CI_Model {
    ...
    private function _get_datatables_query($term = '',$date_awal=null,$date_akhir=null)
    {
        ...
        // $column = array("", "a.MR_No", "a.Patient_Name", "a.Ward", "a.Company_Name", "a.Date_Registration", "a.Status_Data", "a.Date_Perintah_Pulang" , "a.No_EKTM", "a.Last_Order_EKTM_Obat", "a.Last_Terima_EKTM_Obat", "a.Date_Last_Order_Presc", "a.User_Last_Order_Presc", "a.Date_Last_Confrm_Presc", "a.User_Last_Confrm_Presc", "a.Date_Last_Retur_Presc", "a.User_Last_Retur_Presc", "a.Date_Confrm_Retur_Presc", "a.User_Confrm_Retur_Presc", "a.Date_Discharge", "a.User_Discharge", "a.Date_Kirim_Jaminan", "a.User_Kirim_Jaminan", "a.Date_Terima_Jaminan", "a.User_Terima_Jaminan", "a.Keterangan_Terima_Jaminan", "a.Date_Invoice", "a.User_Invoice", "a.Date_Leave_Room", "a.User_Leave_Room"); //Sesuaikan dengan field
        // $this->dbProd23->select("a.IP_Registration_No, a.MR_No, a.Patient_Name, a.Ward, a.Company_Name, a.Date_Registration, a.Status_Data, a.Date_Perintah_Pulang , a.No_EKTM, a.Last_Order_EKTM_Obat, a.Last_Terima_EKTM_Obat, a.Date_Last_Order_Presc, a.User_Last_Order_Presc, a.Date_Last_Confrm_Presc, a.User_Last_Confrm_Presc, a.Date_Last_Retur_Presc, a.User_Last_Retur_Presc, a.Date_Confrm_Retur_Presc, a.User_Confrm_Retur_Presc, a.Date_Discharge, a.User_Discharge, a.Date_Kirim_Jaminan, a.User_Kirim_Jaminan, a.Date_Terima_Jaminan, a.User_Terima_Jaminan, a.Keterangan_Terima_Jaminan, a.Date_Invoice, a.User_Invoice, a.Date_Leave_Room, a.User_Leave_Room");
        $column = array("", "a.MR_No", "a.Patient_Name", "a.Ward", "a.Company_Name", "a.Date_Registration", "a.Status_Data", "a.Date_Perintah_Pulang" , "a.UserKePerintahPulang" , "a.No_EKTM", "a.Last_Order_EKTM_Obat", "a.UserKePDS", "a.Last_Terima_EKTM_Obat", "a.UserTerimaPDS", "a.Date_Last_Order_Presc", "a.User_Last_Order_Presc", "a.Date_Last_Confrm_Presc", "a.User_Last_Confrm_Presc", "a.Date_Last_Retur_Presc", "a.User_Last_Retur_Presc", "a.Date_Confrm_Retur_Presc", "a.User_Confrm_Retur_Presc", "a.Date_Discharge", "a.User_Discharge", "a.Date_Kirim_Jaminan", "a.User_Kirim_Jaminan", "a.Date_Terima_Jaminan", "a.User_Terima_Jaminan", "a.Keterangan_Terima_Jaminan", "a.Date_Invoice", "a.User_Invoice", "a.Date_Leave_Room", "a.User_Leave_Room"); //Sesuaikan dengan field
        $this->dbProd23->select("a.IP_Registration_No, a.MR_No, a.Patient_Name, a.Ward, a.Company_Name, a.Date_Registration, a.Status_Data, a.Date_Perintah_Pulang , a.UserKePerintahPulang, a.No_EKTM, a.Last_Order_EKTM_Obat, a.UserKePDS, a.Last_Terima_EKTM_Obat, a.UserTerimaPDS, a.Date_Last_Order_Presc, a.User_Last_Order_Presc, a.Date_Last_Confrm_Presc, a.User_Last_Confrm_Presc, a.Date_Last_Retur_Presc, a.User_Last_Retur_Presc, a.Date_Confrm_Retur_Presc, a.User_Confrm_Retur_Presc, a.Date_Discharge, a.User_Discharge, a.Date_Kirim_Jaminan, a.User_Kirim_Jaminan, a.Date_Terima_Jaminan, a.User_Terima_Jaminan, a.Keterangan_Terima_Jaminan, a.Date_Invoice, a.User_Invoice, a.Date_Leave_Room, a.User_Leave_Room");// $this->dbProd23->select();
    ...
    {
        // $this->dbProd23->select("a.IP_Registration_No, a.MR_No, a.Patient_Name, a.Company_Name, a.Date, a.Status_Data, a.Date_Perintah_Pulang , a.No_EKTM, a.Date_Ke_PDS, a.Date_Terima_PDS, a.Date_Last_Order_Presc, a.User_Last_Order_Presc, a.Date_Last_Confrm_Presc, a.User_Last_Confrm_Presc, a.Date_Last_Retur_Presc, a.User_Last_Retur_Presc, a.Date_Confrm_Retur_Presc, a.User_Confrm_Retur_Presc, a.Date_Discharge, a.User_Discharge, a.Date_Kirim_Jaminan, a.User_Kirim_Jaminan, a.Date_Terima_Jaminan, a.User_Terima_Jaminan, a.Keterangan_Terima_Jaminan, a.Date_Invoice, a.User_Invoice, a.Date_Leave_Room, a.User_Leave_Room");
        $this->dbProd23->select();
