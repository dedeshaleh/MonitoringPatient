        ...
        "ajax" : {
          ...
          'data'	: { date_awal:date_awal, date_akhir:date_akhir, data_search:data_search, data_payer:data_payer }
            ...
            "columns": [
                        ...
                        { "data" : 'Patient_Name',
                         render : function (data, type, row, meta) {
                          var tool = '<a href="#" data-toggle="tooltip" data-placement="right" title="Kamar 204 Nazareth" onclick="getRinci(`'+row.IP_Registration_No+'`)">'+row.Patient_Name+'</button>';
                          return tool;
                         }
                        },
  ...
  $.ajax({
    ...
    success : function (data) {
      ...
      if ( ((data.Date_Discharge != "") && (data.Date_Discharge != "1901-01-01 00:00:00"))) {
        ...
        if (((data.Date_Perintah_Pulang == "") || (data.Date_Perintah_Pulang == "1901-01-01 00:00:00"))) {
      ...
      document.getElementById('MR').innerHTML = data.MR;
