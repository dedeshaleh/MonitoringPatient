...
class M_dashboard extends CI_Model {
    ...
    private function _get_datatables_query($term = '',$date_awal=null,$date_akhir=null,$data_search=null)
    {
    ...
    function get_datatables($date_awal=null,$date_akhir=null,$data_search=null)
    {
        $term = $_REQUEST['search']['value'];
        $this->_get_datatables_query($term,$date_awal,$date_akhir,$data_search);
        if ($_POST['length'] != -1)
    ...
    function count_filtered($date_awal=null,$date_akhir=null,$data_search=null)
    {
        $term = $_REQUEST['search']['value'];
        $this->_get_datatables_query($term,$date_awal,$date_akhir,$data_search);
        $query = $this->dbProd23->get();
