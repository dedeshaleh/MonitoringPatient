...
class M_LapPatientAno extends CI_Model {
    ...
    private function _get_datatables_query($term = '',$date_awal=null,$date_akhir=null)
    {
        ...
        $column = array("", "a.MR_No", "a.Patient_Name", "a.Company_Name", "a.Date_Registration", "a.Status_Data", "a.Date_Perintah_Pulang" , "a.No_EKTM", "a.Last_Order_EKTM_Obat", "a.Last_Terima_EKTM_Obat", "a.Date_Last_Order_Presc", "a.User_Last_Order_Presc", "a.Date_Last_Confrm_Presc", "a.User_Last_Confrm_Presc", "a.Date_Last_Retur_Presc", "a.User_Last_Retur_Presc", "a.Date_Confrm_Retur_Presc", "a.User_Confrm_Retur_Presc", "a.Date_Discharge", "a.User_Discharge", "a.Date_Kirim_Jaminan", "a.User_Kirim_Jaminan", "a.Date_Terima_Jaminan", "a.User_Terima_Jaminan", "a.Keterangan_Terima_Jaminan", "a.Date_Invoice", "a.User_Invoice", "a.Date_Leave_Room", "a.User_Leave_Room", "a.Perintah_Pulang_To_Discharge", "a.Discharge_To_Terima_Jaminan"); //Sesuaikan dengan field
        $this->dbProd23->select("a.IP_Registration_No, a.MR_No, a.Patient_Name, a.Company_Name, a.Date_Registration, a.Status_Data, a.Date_Perintah_Pulang , a.No_EKTM, a.Last_Order_EKTM_Obat, a.Last_Terima_EKTM_Obat, a.Date_Last_Order_Presc, a.User_Last_Order_Presc, a.Date_Last_Confrm_Presc, a.User_Last_Confrm_Presc, a.Date_Last_Retur_Presc, a.User_Last_Retur_Presc, a.Date_Confrm_Retur_Presc, a.User_Confrm_Retur_Presc, a.Date_Discharge, a.User_Discharge, a.Date_Kirim_Jaminan, a.User_Kirim_Jaminan, a.Date_Terima_Jaminan, a.User_Terima_Jaminan, a.Keterangan_Terima_Jaminan, a.Date_Invoice, a.User_Invoice, a.Date_Leave_Room, a.User_Leave_Room, a.Perintah_Pulang_To_Discharge, a.Discharge_To_Terima_Jaminan");
        // $this->dbProd23->select();
    ...
    public function getDataAll($date_awal=null, $date_akhir=null)
    {
        ...
        $this->dbProd23->where(" ( Discharge_To_Terima_Jaminan > 30 OR Perintah_Pulang_To_Discharge > 120 ) ");
        if ($date_awal != null && $date_akhir != null) {
            $this->dbProd23->where(" Date_Registration BETWEEN '$date_awal' AND '$date_akhir' ");
        }else if ($date_awal != null) {
            $this->dbProd23->where(" Date_Registration = '$date_awal'");
