...
MySQL - 10.4.22-MariaDB : Database - base_web
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`base_web` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
(1,'PT. Paramount Enterprise International','JL. Boulevard Raya','21','Aplikasi Cashless','Cashless Medical Transaction','paramountIcon2.ico','Paramount Enterprise International','1.0.0.0',2022,'2022-10-26 15:20:14','1');
...
(4,'Transaksi','Transaksi','fa fa-exchange-alt',4,'Y','Y','1',0,NULL,NULL,NULL,NULL),
(5,'Aplikasi','Aplikasi','fas fa-wrench',1,'Y','Y','2',2,NULL,NULL,NULL,NULL),
(7,'Menu','Menu','far fa-folder',2,'Y','Y','2',2,NULL,NULL,NULL,NULL),
(43,'Master Karyawan','Karyawan','fas fa-users',2,'Y','Y','2',3,NULL,NULL,NULL,NULL),
...
(48,'Karyawan Relasi','Karyawan_relasi','fas fa-users',3,'Y','Y','2',3,NULL,NULL,NULL,NULL),
(49,'Data Plafond','Plafond','fas fa-wallet',1,'Y','Y','2',4,NULL,NULL,NULL,NULL),
(50,'ASSETS','Assets','fa fa-exchange-alt',2,'Y','Y','2',3,NULL,NULL,NULL,NULL),
